...
Map<String, dynamic> environment = {
  ...
  "serverConfig": {
    ...
    'blog': 'https://thekinggo.com',

    /// remove to use as native screen
    'forgetPassword':
        'https://thekinggo.com/wp-login.php?action=lostpassword'
  },
  ...
  "advanceConfig": {
    ...
    "PrivacyPoliciesPageUrlOrId": "https://thekinggo.com/privacy/",

    "SupportPageUrl": "https://support.thekinggo.com/",

    "DownloadPageUrl": 'https://fluxstore.app/',

    "AboutUSPageUrl": "https://codecanyon.net/user/inspireui",

    "NewsPageUrl": "https://products.thekinggo.com/",

    "FAQPageUrl": "https://products.thekinggo.com/have-a-question/",
  ...
  "loginSetting": {
    ...
    /// https://support.thekinggo.com/help-center/articles/42/44/32/social-login#login
  ...
  "onBoardingConfig": {
    ...
    'data': [
      {
        'title': 'Welcome to King Go',
        'image': 'assets/images/fogg-delivery-1.png',
        'desc': 'King Go is on the way to serve you. '
      },
      {
  ...
  "adConfig": {
    ...
    /// To update manually, follow this below doc:
    /// https://support.thekinggo.com/help-center/articles/42/44/17/admob-and-facebook-ads#2-setup-google-admob-for-flutter
  ...
  /// Ref: https://support.thekinggo.com/help-center/articles/3/25/16/google-map-address
  "googleApiKey": {
  ...
  "deliveryConfig": {
    ...
    'appName': 'King Go Delivery',
    'dashboardName1': 'King Go',
